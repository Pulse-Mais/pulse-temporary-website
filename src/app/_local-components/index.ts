...
import {  BookOpenText, ChalkboardTeacher, Student, UsersFour, LinkedinLogo } from "@phosphor-icons/react"
import { Button } from "@/components/UI/Button"
import Image from 'next/image';
import Link from 'next/link';
import { ProfileIcon } from '@/app/(public)/sobre/_components/ProfileIcon';
import { UserPersonaCard } from '@/components/global-components/UserPersonaCard';
