  ...
  return (
    <footer className="relative w-full bg-white mt-[70px] overflow-hidden pb-[100px]">
      ...
      <div className="relative max-w-[1440px] mx-auto flex flex-row justify-between items-start z-10 px-8 pt-[70px]">
        {/* Coluna 1 - Logo */}
        {/* MODIFICAÇÃO AQUI: Em telas 2xl, a logo vira absolute para acompanhar o shape */}
        <div className="flex-shrink-0 2xl:absolute 2xl:left-[-150px] 2xl:top-[70px] 2xl:z-20">
          <Image
        ...
        {/* 2. GRUPO DE TEXTOS */}
        {/* MODIFICAÇÃO AQUI: Adicionado 2xl:ml-auto */}
        <div className="flex flex-row gap-[60px] 2xl:ml-auto">
          {/* Coluna Mapa do Site */}
          <div>
            ...
            <ul className="flex flex-col gap-[10px]">
              <li>
                <Link
                  href="/sobre"
                  className="text-[16px] font-normal text-[#6B6D6E] hover:text-[#003870] transition-colors"
                >
                  Sobre
                </Link>
              </li>
            ...
            <ul className="flex flex-col gap-[10px]">
              <li>
                ...
                >
                  ...
                  />
                  <span className="text-[16px] font-normal text-[#6B6D6E] hover:text-[#003870] transition-colors">
                    Instagram
                  </span>
                </Link>
              </li>
